import { faCommentAlt, faFileAlt, faFileWord, faFolderOpen, faGlobe, faHome, faUser } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="flex flex-col my-auto w-full">
        ...
        {tab === "community" && <div className="text-lg">
          <div className="mt-2 font-bold">
            Share anything with your community.
          </div>
          <div className="mt-4">
            Making music? Share it with your community using the Files component.
            Need a chat room? Use the Chat component. Fed up with constantly re-making the same info channel? Just use the Page component. With Starship, you get to choose how your community will be organized.
          </div>
        </div>}
        ...
        {tab === "school" && <div className="text-lg">
          ...
          <div className="mt-4">
            <Markdown>
              Share homework with your students using the Files component. Help students with the Chat component. Post information about your class with the Page component. Plus, you can do all of this with support for
              sharing formulas with $LaTeX$*.
            </Markdown>
